        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">FinvoyGlobal <span className="bg-gradient-to-r from-yellow-500 to-amber-600 bg-clip-text text-transparent">Hi-Five</span></h1>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-purple-100 mb-6">
                Share your referral code and earn 500 points for each friend who joins FinvoyGlobal Hi-Five
              </p>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-bold">FinvoyGlobal Hi-Five</h3>
                <p className="text-gray-400 text-sm">Rewards that travel with you</p>
              </div>
            </div>
            
            <div className="text-center">
              <p className="text-gray-400">© 2025 FinvoyGlobal Hi-Five Rewards Program</p>
