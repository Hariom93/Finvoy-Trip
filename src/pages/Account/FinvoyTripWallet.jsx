...
const FinvoyTripWallet = () => {
  ...
  const faqs = [
    {
      id: 1,
      question: "What is Finvoy-Global Wallet?",
      answer: "Finvoy-Gobal Wallet is a secure digital wallet that stores your travel funds, rewards, and credits. You can use it to make faster bookings, manage refunds, and earn rewards on your transactions."
    },
    {
      id: 2,
      question: "How does balance get added to Finvoy-Gobal Wallet?",
      answer: "There are 2 types of balances which can get credited to your Finvoy-Gobal Wallet - Credit and Reward.",
      details: [
        {
          type: "Credit balance",
          description: "is the amount earned via cancellation refunds. Credit balance gets added to the Finvoy-Gobal Wallet when you choose to get Refunds via Finvoy-Gobal Wallet during cancellation, e.g., let be either Credit Balance shall be in the case of a loan or credit balance."
        },
        {
          type: "Reward balance",
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold">Finvoy-Gobal Wallet</h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg mb-6 overflow-hidden">
          <div className="p-5 border-b border-gray-100">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-bold text-gray-800">Finvoy-Gobal Wallet balance</h2>
          ...
          <div className="p-5">
            ...
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                Your transaction history will appear here once you start using your Finvoy-Gobal Wallet.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800">Finvoy-Gobal</span>
            </div>
            
            <div className="text-gray-600 text-sm text-center">
              <p>© 2025 Finvoy-Gobal Mobile Pvt. Ltd. All rights reserved.</p>
              <p className="mt-1 text-gray-500">Finvoy-Gobal Wallet is a digital wallet service</p>
            </div>
